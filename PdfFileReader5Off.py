...
Purpose:
    ...
    >>>> The Off at the end of the file name means that the print 
    statements in this file are turned Off. If youd like them to 
    be turned on, simply open the PdfFileReader5On.py file instead.
